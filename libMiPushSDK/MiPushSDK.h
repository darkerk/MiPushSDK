...
+ (void)registerMiPush:(id<MiPushSDKDelegate>)delegate type:(UIUserNotificationType)type;
+ (void)registerMiPush:(id<MiPushSDKDelegate>)delegate type:(UIUserNotificationType)type connect:(BOOL)connect;
